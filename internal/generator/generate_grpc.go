...
// generate_grpc.go â€” gRPC generator with file-based detection + grpc_type metadata.
//
...
//     gRPC service. There is NO `_GRPC` suffix requirement on methods â€”
...
//
//  4. Generation depends on grpc_type â€” each method is generated as the
...
func generateGRPC(modulePath, name string, args []string) error {
	...
	fmt.Printf("\nNote: re-running `breeze generate grpc %s` is safe â€” pass --force\n", name)
	fmt.Printf("to overwrite existing generated files.\n")
	return nil
}

// â”€â”€â”€ Interface scanning â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
func grpcTypeToKind(grpcType string) grpcMethodKind {
	...
	default:
		return grpcUnary // unknown â†’ default to unary
	}
}

// â”€â”€â”€ Signature validation (type-driven) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
func validateGRPCMethod(ifaceName string, m *grpcMethod) error {
	fail := func(rule string) error {
		return fmt.Errorf(
			"%s.%s: invalid signature for grpc_type=%q â€” %s\n"+
				"  got: %s(%s) (%s)\n"+
				"  expected shape: %s",
...
// â”€â”€â”€ Method signature parsing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
