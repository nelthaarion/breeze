...
//     generated file that imports both — and features_generated.go imports the
...
func generateMiddleware(modulePath, name string, args []string) error {
	...
	b.WriteString("// Code generated by `breeze generate middleware` — edit freely.\n")
	...
	b.WriteString("// calling it short-circuits the request — that is how a middleware rejects\n")
