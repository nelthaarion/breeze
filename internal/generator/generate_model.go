...
func generateModel(modulePath, name string, args []string) error {
	...
	// â”€â”€ the struct â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	var b strings.Builder
	b.WriteString("// Code generated by `breeze generate model` â€” edit freely.\n")
	...
	modelPath := filepath.Join("models", fileSlug(name)+".go")
	if err := writeGeneratedGoFile(modelPath, b.String(), *force); err != nil {
		return err
	}

	notes := []string{fmt.Sprintf("Import as:    \"%s/models\"", modulePath)}

	// â”€â”€ the migration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	if !*skipMigration {
