...
// blocks for other names â€” and any hand-written code outside the markers â€”
...
const (
	...
	// contains â€” if it is missing, the file has been damaged and silently
...
func upsertBlock(req blockRequest) error {
	...
	// one â€” so a block written with a checksum is still found, and replacing it
...
// still matches after the file has been through format.Source â€” both as part of
...
// rewrote this block" â€” both are just "differs from what I would write now" â€”
...
// puts a blank line between a declaration and a comment that follows it â€” so
...
// at column 0 â€” and Go's parser ignores indentation entirely, so trimming first
...
// means either new flags or a hand edit inside the markers â€” and the second of
